...
**Paldi (P)**         | **Nehru Bridge Ashram Road (N)**        |**APMC market (A)**
----------------|--------------|-----------------
![](images/paldi.png) |![](images/nehru.png)||![](images/apmc.png)
4-way signalized intersection | 4-way signalized intersection | 3-way unsignalized intersection
